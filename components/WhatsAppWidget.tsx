...
const WHATSAPP_NUMBER = "917010776767";
                            ...
                            <AnimatePresence>
                                {(showTooltip || false) && (
                                    <motion.div
                                        ...
                                        className="absolute bottom-full right-0 mb-4 whitespace-nowrap bg-[var(--bg-secondary, #1a1a1a)] border border-[var(--accent-gold, #c5a67c)]/30 text-[var(--text-primary, #ffffff)] px-4 py-2 rounded-xl shadow-2xl backdrop-blur-md"
                                    >
                                        <div className="text-xs font-medium tracking-wider uppercase font-outfit">
                                            Get in Touch
                                        </div>
                                        {/* Arrow */}
                                        <div className="absolute top-full right-6 w-3 h-3 bg-[var(--bg-secondary, #1a1a1a)] border-r border-b border-[var(--accent-gold, #c5a67c)]/30 transform rotate-45 -translate-y-1.5" />
                                    </motion.div>
                                )}
                            </AnimatePresence>
